...
import (
	...
	"github.com/anthony-dong/golang/pkg/codec/thrift_codec/test/thriftstruct"
	...
	return &thriftstruct.TestArgs{
		Req: &thriftstruct.TestRequest{
			Data: &thriftstruct.NormalData{
				FI64: utils.Int64Ptr(1),
				FI32: utils.Int32Ptr(1),
			},
		},
	}
}
...
func NewNormalData() *thriftstruct.NormalData {
	return &thriftstruct.NormalData{
		FI64:          utils.Int64Ptr(1),
		FI32:          utils.Int32Ptr(1),
		FI16:          utils.Int16Ptr(1),
		FByte:         utils.Int8Ptr(1),
		FDouble:       utils.Float64Ptr(1.1111),
		FString:       utils.StringPtr("hello world"),
		FBool:         utils.BoolPtr(true),
...
func NewNormalStruct() *thriftstruct.NormalStruct {
	return &thriftstruct.NormalStruct{
		F_1: utils.StringPtr("hello world"),
	}
}
